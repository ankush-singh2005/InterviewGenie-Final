...
export async function getInterviewsByUserId(
  ...
  // Only return interviews that have feedback (completed interviews)
  ...
  for (const doc of interviews.docs) {
    ...
    // Only include interviews that have feedback (completed)
    if (!feedbackSnapshot.empty) {
      interviewsWithFeedback.push(interviewData);
    }
  }
